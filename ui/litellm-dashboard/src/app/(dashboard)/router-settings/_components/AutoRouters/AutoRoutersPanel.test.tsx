...
const DEPLOYMENTS = [
  ...
  },
  {
    ...
    model_info: { id: "auto-1", created_at: "2026-07-28T21:40:09.900000+00:00" },
  },
  {
  ...
  },
  {
    ...
    model_info: { id: "auto-2", created_at: "2026-07-27T10:00:00.000000+00:00" },
  },
];
...
describe("AutoRoutersPanel", () => {
  ...
  // every write affordance absent when told no, rather than let a submit 403 later.
  it("shows the list but no write affordances when canModify is false", async () => {
    ...
    expect(screen.queryByRole("button", { name: "tri-tier-router" })).not.toBeInTheDocument();
  });
